    ...
    homepageRows: [
      {
        ...
        status: copy('experiments.parkerConfirmationRepair.status', 'consolidated draft / synthetic eval green'),
    ...
    homepageRows: [
      {
        ...
        status: copy('experiments.parkerWrapperBoundary.status', 'consolidated draft / inactive harness green'),
